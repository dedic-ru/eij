...
function t_animate__startAnimation() {
    ...
    $(window).width() < 1200 && (a = t_animate__checkMobile(a), e = t_animate__checkMobile(e), n = t_animate__checkMobile(n)), (void 0 !== a && 0 != a.length || void 0 !== n && 0 != n.length || void 0 !== e && 0 != e.length) && (t_animate__setAnimationState(a, e, n), a = a.filter(".r:has(.t-animate_wait)"), n = n.filter(".t-animate_wait"), e = e.filter(".r:has(.t-animate_wait)"), t(), $(window).bind("resize", t_throttle(t, 200)), setInterval(t, 5e3), $(window).bind("scroll", t_throttle(function() { t_animate__animateOnScroll(a, e, n) }, 200)), $(".r").find(".t-popup").bind("scroll", t_throttle(function() {
        var t = $(window).scrollTop() + $(window).height(),
            a = $(this).has(".t-animate[data-animate-chain=yes]");
...
function t_animate__animateChainItemsOnScroll(t, a, e) {
    var n = $(t[a]),
        ...
        d = t_animate__getSectionHeadDealy(n);
    $(i[0]).addClass("t-animate__chain_first-in-row");
    for (var l = 0; l < i.length; l++) {
        var c = $(i[l]),
            f = t[a].itemsOffsets[l];
        if (!(f < e)) break;
...
function t_animate__animateNumbers(t) {
    t.each(function() {
        ...
        if (t.find("span:not(.t-animate__number):first").each(function() { e = $(this).attr("style") }), a) {
            ...
            var d = [];
            t.find(".t-animate__number").each(function() { d.push($(this).text()) }), o.forEach(function(n, s) {
