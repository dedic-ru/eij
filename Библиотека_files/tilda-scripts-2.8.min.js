...
function t_onFuncLoad(o, i, r) {
    var n;
    "function" == typeof window[o] ? i() : (n = Date.now(), setTimeout(function e() {
        var t = Date.now();
        if ("function" != typeof window[o]) {
            if (7e3 < t - n) throw new Error(o + " is undefined");
            setTimeout(e, r || 100)
        } else i()
    }))
}
window.isSearchBot = !1, /Bot/i.test(navigator.userAgent) && (window.isSearchBot = !0), window.isMobile = !1, window.$isMobile = !1, /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (window.isMobile = !0, window.$isMobile = !0), window.isiOS = !1, /iPhone|iPad|iPod/i.test(navigator.userAgent) && (window.isiOS = !0), window.isiOSVersion = "", !window.isiOS || null !== (version = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/)) && (window.isiOSVersion = [parseInt(version[1], 10), parseInt(version[2], 10), parseInt(version[3] || 0, 10)]), window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang,
    function(u) {
        ...
        u(document).ready(function() {
            ...
            var o;
            u("div[data-customstyle=yes]").each(function(e) { 30 < u(this).css("font-size").replace("px", "") && (u(this).css("font-size", ""), u(this).css("line-height", "")) }), u("[field]").find("span").each(function(e) { 30 < u(this).css("font-size").replace("px", "") && u(this).css("font-size", "") }), u(".t-title, .t-name, .t-heading, .t-descr, .t-text, .t-subtitle").not(".tn-elem, .tn-atom").each(function(e) {
                var t;
                void 0 !== (o = u(this).attr("style")) && "" != o && -1 < o.indexOf("font-size") && 30 < u(this).css("font-size").replace("px", "") && (t = o.replace("font-size", "fontsize").replace("line-height", "lineheight"), u(this).attr("style", t))
            })
        }))
    }(jQuery),
    function(c) {
        function e() { this.setScrollListener() }
        e.prototype.videoTags = [], e.prototype.defaultConfig = { isNeedStop: !1 }, e.prototype.videoConfigs = [], e.prototype.registerNewVideo = function(e, t) { if (!(e instanceof HTMLVideoElement)) throw new Error("Wrong tag passed into registerNewVideo"); return -1 == this.videoTags.indexOf(e) && (this.videoTags.push(e), this.videoConfigs.push(void 0 === t ? this.defaultConfig : t), this.scrollCb("", !0), !0) }, e.prototype.unergisterVideo = function(e) { if (!(e instanceof HTMLVideoElement)) throw new Error("Wrong tag passed into unregisterNewVideo"); var t; return -1 < (t = this.videoTags.indexOf(e)) && ("function" == typeof e.remove ? e.remove() : e.parentNode && e.parentNode.removeChild(e), this.pauseVideo(e, this.videoConfigs[t]), this.videoTags.splice(t, 1), this.videoConfigs.splice(t, 1), !0) }, e.prototype.pauseVideo = function(e, t) {
            if (!t) throw new Error("Wrong config type!");
            e.pause(), t.isNeedStop && e.load()
        }, e.prototype.setScrollListener = function() { c(window).bind("scroll", t_throttle(jQuery.proxy(this.scrollCb, this), 200)) }, e.prototype.scrollCb = function(e, t) {
        ...
        }, e.prototype.getVideoObject = function(e) { for (var t = 0, o = this.videoTags.length; o < t; t++) { var i = this.videoTags[t]; if (i.v === e) return i } return null }, e.prototype.getVideoBoundingRect = function(e, t) { void 0 === t && (t = !0); return (t && c(e).parents(".r")[0] || e).getBoundingClientRect() }, window.videoLoadProcessor = new e
    }(jQuery),
    function(C) {
        function e() {
        ...
        function S(e) {
            ...
            if (300 < o && e < o + 40 && (1e3 < (o = o + 120) && (o += 100), console.log("auto correct cover height: " + o), t.find(".t-cover").height(o), t.find(".t-cover__filter").height(o), t.find(".t-cover__carrier").height(o), t.find(".t-cover__wrapper").height(o), 0 == window.isMobile && setTimeout(function() {
                ...
                }, 2e3), "function" == typeof window.t_lazyload_updateResize_elem)) try { window.t_lazyload_updateResize_elem(t.find(".t-cover__carrier")) } catch (e) { console.log("error:" + e) }
        }
        ...
        function q(e) {
            ...
            O(e) && (console.log("new fix style background-position: fixed"), t = i.querySelector(".t-cover__container"), i = (o = i.querySelector(".t-cover")).style.height, o.style.height = 0, t.style.height = i, window["cover" + e + "fixbackgroundstyles"] = !0)
        }
        ...
        e.prototype.defaultConfig = { orientation: "vertical", speedFactor: 1, automated: !1 }, e.prototype.sequenceObjects = [], e.prototype.recalculateAllSequencesOffsets = function() { this._resizeTimeout && clearTimeout(this._resizeTimeout), this._resizeInterval && clearInterval(this._resizeInterval), this._resizeTimeout = setTimeout(jQuery.proxy(function() { this.scrollCb(), this._resizeInterval = setInterval(jQuery.proxy(this.scrollCb, this), 500) }, this), 10) }, e.prototype.registerNewBlock = function(t) {
            ...
            var i = t.querySelector('[data-hook="sequence-holder"]'),
                ...
                n = (this.itemHeight, { sequenceBlock: t, sequenceHolder: i, sequenceHolderTopOffset: r, sequenceHeight: a, items: n, started: !1, prevBackgroundColor: "" });
        ...
        }, e.prototype.getAbsoluteTopOffset = function(e) { var t = e.offsetTop; for (e = e.offsetParent; null != e;) t += e.offsetTop, e = e.offsetParent; return t }, e.prototype.processSequence = function(e) {
        ...
        }, e.prototype.setScrollCb = function() { this._scrollCb = jQuery.proxy(this.scrollCb, this), C(window).bind("scroll", t_throttle(this._scrollCb, 200)) }, window.sequenceController = new e, window.processVideo = function(e) {
            mp4Src = C(e).attr("data-content-video-url-mp4"), webmSrc = C(e).attr("data-content-video-url-webm"), C(e).css("background-color", "transparent"), C(e).css("background-image", "");
            var t = { mp4: mp4Src, webm: webmSrc, preload: "none", autoplay: !1, loop: !0, scale: !0, zIndex: 0, width: "100%" };
            vid = C(e).videoBG(t), videoLoadProcessor.registerNewVideo(vid, { isNeedStop: !1 })
        }, window.cover_init = function(T) {
            C(document).ready(function() {
                var e, t, o, i, r = document.body.querySelector("#coverCarry" + T),
                    n = C(r),
                    a = n.attr("data-content-cover-bg"),
                    c = n.attr("data-content-cover-height"),
                    d = n.attr("data-content-cover-parallax"),
                    s = n.attr("data-content-video-url-mp4"),
                    l = n.attr("data-content-video-url-webm"),
                    p = n.attr("data-content-video-url-youtube"),
                    u = n.attr("data-content-video-noloop"),
                    h = n.attr("data-content-video-nomute"),
                    m = n.attr("data-content-bg-base64"),
                ...
                k.length && k.load(function() { setTimeout(function() { S(T), q(T) }, 500) }), window.isMobile && C(window).on("orientationchange", function() { S(T), q(T) }), "" === s && "" === l && "" === p || 0 == window.isMobile && ("" != p || "" == s && "" == l ? "" != p && (n.css("background-color", "#000000"), n.css("background-image", ""), n.attr("data-content-cover-bg", ""), b = 0, (_ = C(window)).scroll(function() {
                    ...
                    y && window.clearTimeout(y), y = window.setTimeout(function() {
                        var e, t, o;
                        0 < b || (e = n.offset().top, t = n.height(), e - 500 < (o = _.scrollTop()) + _.height() && o <= e + t + 500 && ((t = n.videoBG({ mp4: s, webm: l, poster: "", preload: "none", autoplay: "true", loop: w, volume: 1, scale: !0, zIndex: 0, width: "100%" })).setAttribute("muted", g), t.setAttribute("playsinline", ""), videoLoadProcessor.registerNewVideo(t), b = 1))
                    }, 100), "fixed" == d && "yes" == v && (e = x.offset().top, t = x.height(), o = _.scrollTop(), e + t - _.height() <= o ? (n.css("position", "absolute"), n.css("bottom", "0px"), n.css("top", "auto")) : e <= o ? (n.css("position", "fixed"), n.css("top", "0px")) : o < e && (n.css("position", "relative"), n.css("top", "auto")))
                }), _.scroll())), "dynamic" == d && 0 == window.isMobile && (h = n.offset().top - (n.offset().top - C(window).height()), n.height() < C(window).height() && n.height(n.height() + .2 * h), n.parallax(.2, !0)), "yes" == m && "" != a && "" == s && "" == l && "" == p && (C("<img/>").attr("src", a).load(function() { C(this).remove(), n.css("background-image", "url('" + a + "')"), n.css("opacity", "1") }), n.css("background-image", ""), n.css("opacity", "0"), n.css("transition", "opacity 25ms"));
                p = C("#rec" + T).find(".t-cover__arrow-wrapper");
                0 < p.length && p.click(function() {
                    var e = C("#rec" + T).height();
                    0 < e && C("html, body").animate({ scrollTop: C("#rec" + T).offset().top + e }, 500)
                })
            })
        }, C(document).ready(function() {
            "edit" != C(".t-records").attr("data-tilda-mode") && C(".t-cover__carrier").each(function() {
                var e = C(this).attr("data-content-cover-id");
                0 < e && cover_init(e)
            })
        });
        var o = C.Deferred();
        ...
        function c(e, t) {
            ...
            var o, i, r, n, a = e.find("iframe"),
                ...
                l = .5625;
            0 < s && (l = +parseFloat(s)), "yes" != c ? (i = -1 < (t = t || "100vh").indexOf("vh") ? (o = (o = window.innerHeight) || C(window).height(), Math.floor(o * (parseInt(t) / 100))) : parseInt(t), s = n = (r = (r = Math.floor(parseInt(window.innerWidth))) || C(window).width()) * l, c = n, o = 1, "yes" == d || (s = s + 110 + 110, c = n - 220), c < i && (o = n < i ? i / n + .02 : n / i + .02), c = Math.floor(r * o), i = (o = Math.floor(s * o)) - i, r = c - r, a.height(o + "px"), a.width(c + "px"), 0 < i && a.css("margin-top", -Math.floor(i / 2) + "px"), 0 < r && a.css("margin-left", -Math.floor(r / 2) + "px")) : (t || (n = Math.floor(e.width() * l)), t && -1 < t.indexOf("vh") ? n = Math.floor(window.innerHeight * (parseInt(t) / 100)) : t && (n = parseInt(t)), a.css("width", "100%"), a.height(n + "px"))
        }
        window.processYoutubeVideo = function(s, a) {
            ...
            o.then(function() {
                ...
                n.src = function(e, t, o) {-1 == e.indexOf("https://www.youtube.com/embed") && (e = "https://www.youtube.com/embed" + ("/" == e[0] ? e : "/" + e)); var i = location.protocol + "//" + location.host; return e = "yes" != t ? (e[e.length - 1], e + "?autoplay=1&loop=1&enablejsapi=1&&playerapiid=featuredytplayer&controls=0&modestbranding=1&rel=0&showinfo=0&color=white&iv_load_policy=3&theme=light&wmode=transparent&origin=" + i + "&playlist=" + function(e) { for (var t = e.split("/"), o = null, i = 0, r = t.length; i < r; i++) "embed" == t[i] && (o = t[i + 1]); return o }(e)) : (e[e.length - 1], e + "?autoplay=0&loop=0&enablejsapi=1&&playerapiid=featuredytplayer&controls=1&modestbranding=1&rel=0&showinfo=0&color=black&iv_load_policy=3&theme=dark&wmode=transparent&origin=" + i), "yes" !== o && (e += "&mute=1"), e }(o, r, d), n.frameBorder = 0, n.allow = "autoplay", s.appendChild(n), 0 == window.isMobile && new YT.Player(n, {
                    events: {
                        onReady: function(e) {
                            var t, o, i, r, n, a, c;
                            t = s, o = e.target, i = d, n = C(window), a = C(t), c = 0, n.scroll(function() { r && (window.clearTimeout(r), 15 <= c && (l(a, n, o, i), c = 0), c++), r = window.setTimeout(function() { l(a, n, o, i), c = 0 }, 100) }), n.scroll(), e.target.setVolume && "yes" != d && e.target.setVolume(0), e.target.setLoop(!0)
                        },
                        onStateChange: function(o) {
                            var e;
                            o.target.setVolume && "yes" != d && o.target.setVolume(0), -1 !== o.data || 0 <= (e = window.fix_scrolltop_beforestop_youtube) && (C("html, body").scrollTop(e), delete window.fix_scrolltop_beforestop_youtube), o.data === YT.PlayerState.PLAYING ? t = window.setInterval(function() {
        ...
        }, window.onYouTubeIframeAPIReady = function() { o.resolve() }
    }(jQuery),
    function() {
    ...
    function(l) {
        l.fn.videoBG = function(e, t) {
            ...
            var t, o = l(window).width(),
                i = l(window).height();
            e.css("min-height", 0).css("min-width", 0), e.parent().width(o).height(i), o / i > e.aspectRatio ? (e.width(o).height("auto"), (t = (e.height() - i) / 2) < 0 && (t = 0), e.css("top", -t)) : (e.width("auto").height(i), (t = (e.width() - o) / 2) < 0 && (t = 0), e.css("left", -t), 0 === t && setTimeout(function() { l.fn.videoBG.setFullscreen(e) }, 500)), l("body > .videoBG_wrapper").width(o).height(i)
            ...
            var o, i = l("<video/>");
            i.css("position", "relative").css("z-index", e.zIndex).attr("poster", e.poster).css("top", 0).css("left", 0).css("min-width", "100%").css("min-height", "100%"), i.prop("autoplay", e.autoplay), i.prop("loop", e.loop), i.prop("muted", e.muted), 0 < e.volume ? i.prop("volume", e.volume) : i.prop("volume", 0), e.fullscreen && (i.bind("canplay", function() { i.aspectRatio = i.width() / i.height(), l.fn.videoBG.setFullscreen(i) }), l(window).resize(function() { clearTimeout(o), o = setTimeout(function() { l.fn.videoBG.setFullscreen(i) }, 100) }), l.fn.videoBG.setFullscreen(i));
            var r = i[0];
            e.loop && (loops_left = e.loop, i.bind("ended", function() { loops_left && r.play(), !0 !== loops_left && loops_left-- })), i.bind("canplay", function() { e.autoplay && r.play() }), l.fn.videoBG.supportsVideo() && (l.fn.videoBG.supportType("webm") && "" != e.webm ? i.attr("src", e.webm) : l.fn.videoBG.supportType("mp4") && "" != e.mp4 ? i.attr("src", e.mp4) : i.attr("src", e.ogv));
            var n = l("<img/>");
        ...
        }, l.fn.videoBG.supportsVideo = function() { return document.createElement("video").canPlayType }, l.fn.videoBG.supportType = function(e) {
            ...
            return !1
        }, l.fn.videoBG.wrapper = function() { var e = l("<div/>"); return e.addClass("videoBG_wrapper").css("position", "absolute").css("top", 0).css("left", 0), e }, l.fn.videoBG.defaults = { mp4: "", ogv: "", webm: "", poster: "", autoplay: !0, loop: !0, scale: !1, position: "absolute", opacity: 1, textReplacement: !1, zIndex: 0, width: 0, height: 0, fullscreen: !1, imgFallback: !0 }
    }(jQuery),
    function(c) {
        var d = c(window),
            s = d.height();
        d.resize(function() { s = d.height() }), c.fn.parallax = function(r, e) {
            var n, t = c(this),
            ...
            a && t.css("position", "relative"), window.correctFirstTop4Parallax = function() { t.each(function() { t.offset().top }) }, window.correctFirstTop4Parallax(), n = e ? function(e) { return e.outerHeight(!0) } : function(e) { return e.height() }, (arguments.length < 1 || null === r) && (r = .1), (arguments.length < 2 || null === e) && (e = !0), o(), c(window).resize(window.correctFirstTop4Parallax), d.bind("scroll", o).resize(o), "complete" !== document.readyState && window.addEventListener("load", function() { o() })
        }
    ...
    function(v) {
        Tilda.sendEcommerceEvent = function(e, t) {
            ...
            for (var o, i, r, n = "", a = 0, c = [], d = "", s = "", l = "", p = 0; p < t.length; p++) {
                "" < n && (n += ", "), n += (r = t[p]).name, a += r.price, i = "", void 0 !== r.options && 0 < r.options.length && v.each(r.options, function(e, t) { i += t.option + ": " + t.variant + "; " });
                var u = { name: r.name, price: r.price, variant: i, quantity: 1 };
            ...
            "add" != e && "remove" != e || (o = "/tilda/cart/" + e + "/", 0 < d && (o += "" + d), 0 < s ? o += "-u" + s : 0 < l && (o += "-" + l)), "detail" == e && (o = "/tilda/product/detail/", 0 < s ? o += s + "/" : (0 < d && (o += "r" + d), 0 < l && (o += "-l" + l))), "purchase" == e && (o = "/tilda/rec" + d + "/payment/"), (u = { ecommerce: {} }).ecommerce[e] = { products: c }, Tilda.sendEventToStatistics(o, n, u, a)
            ...
            if (o = o || window.location.href, 0 < (i = i ? parseFloat(i) : 0))
                if (window.dataLayer || (window.dataLayer = []), -1 != e.indexOf("/tilda/") && -1 != e.indexOf("/payment/") && window.tildaForm && "" < window.tildaForm.orderIdForStat) o = { ecommerce: { purchase: { actionField: { id: window.tildaForm.orderIdForStat, revenue: window.tildaForm.amountForStat }, products: window.tildaForm.arProductsForStat } } }, window.tildaForm.tildapayment && window.tildaForm.tildapayment.promocode && (o.ecommerce.purchase.actionField.coupon = window.tildaForm.tildapayment.promocode), o.event = "purchase";
                    ...
                    if (o && o.event) {
                        try {
                            if (window.Tilda.isLoadGAEcommerce || (window.Tilda.isLoadGAEcommerce = !0, ga("require", "ec")), ga("set", "currencyCode", l), "purchase" == o.event) {
                                ...
                                for (g = 0; g < p; g++) w = o.ecommerce.purchase.products[g], ga("ec:addProduct", { id: w.id || g, name: w.name, price: parseFloat(w.price).toFixed(2), quantity: w.quantity });
                                ...
                                for (g = 0; g < p; g++) w = o.ecommerce.add.products[g], ga("ec:addProduct", { id: w.id || g, name: w.name, price: parseFloat(w.price).toFixed(2), quantity: w.quantity });
                                ga("ec:setAction", "add")
                            } else if ("removeFromCart" == o.event && o.ecommerce.remove) {
                                p = o.ecommerce.remove.products.length;
                                for (g = 0; g < p; g++) w = o.ecommerce.remove.products[g], ga("ec:addProduct", { id: w.id || g, name: w.name, price: parseFloat(w.price).toFixed(2), quantity: w.quantity });
                                ga("ec:setAction", "remove")
                            } else if ("viewProduct" == o.event && o.ecommerce.detail) {
                                p = o.ecommerce.detail.products.length;
                                for (g = 0; g < p; g++) w = o.ecommerce.detail.products[g], ga("ec:addProduct", { id: w.id || g, name: w.name, price: parseFloat(w.price).toFixed(2), quantity: w.quantity });
                                ga("ec:setAction", "detail")
                            }
                        } catch (e) {}
                        ga("send", { hitType: "pageview", page: e, title: t, params: o })
                    } else ga("send", { hitType: "pageview", page: e, title: t });
            else ga("send", { hitType: "event", eventCategory: "tilda", eventAction: e, eventLabel: t, eventValue: i });
            if (window.mainMetrikaId && 0 < window.mainMetrikaId && "function" == typeof ym && (n ? (r = { title: t }, 0 < i && (r.params = { order_price: i }, l && (r.params.currency = l)), ym(window.mainMetrikaId, "hit", e, r)) : 0 < i ? (r = { order_price: i }, l && (r.currency = l), ym(window.mainMetrikaId, "reachGoal", e, r)) : ym(window.mainMetrikaId, "reachGoal", e)), "" < window.mainMetrika && window[window.mainMetrika] && (n ? 0 < i ? window[window.mainMetrika].hit(e, { title: t, order_price: i, params: o }) : window[window.mainMetrika].hit(e, { title: t }) : 0 < i ? window[window.mainMetrika].reachGoal(e, { title: t, params: o, order_price: i }) : window[window.mainMetrika].reachGoal(e, { title: t, referer: o })), null != window.fbq && 0 == d) try {
                if (n)
                    if (-1 == e.indexOf("tilda/") || -1 == e.indexOf("/payment/") && -1 == e.indexOf("/submitted/"))
                        if (o && o.event && 0 < i)
                            if ("addToCart" == o.event && o.ecommerce.add) {
                                ...
                                window.fbq("track", "AddToCart", { content_ids: u, content_type: "product", value: i, currency: l })
                            } else if ("viewProduct" == o.event && o.ecommerce.detail) {
                    p = o.ecommerce.detail.products.length, u = [];
                    for (g = 0; g < p; g++) w = o.ecommerce.detail.products[g], u.push(w.id || w.uid || w.name);
                    window.fbq("track", "ViewContent", { content_ids: u, content_type: "product", value: i, currency: l })
                } else e.indexOf("tilda/popup"), window.fbq("track", "ViewContent", { content_name: t, content_category: e });
                else e.indexOf("tilda/popup"), window.fbq("track", "ViewContent", { content_name: t, content_category: e });
                else 0 < i && l ? window.fbq("track", "InitiateCheckout", { content_name: t, content_category: e, value: i, currency: l }) : window.fbq("track", "Lead", { content_name: t, content_category: e });
                else window.fbq("track", e, { content_name: t, value: i })
            } catch (e) {}
            if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && 0 == s) try {
                if (n) {
                    var h = v("#allrecords").data("vk-price-list-id") ? parseInt(v("#allrecords").data("vk-price-list-id")) : 0,
                        ...
                        f = !1;
                    if (o && o.event)
                        if (f = { products: [], currency_code: "", total_price: 0 }, "purchase" == o.event && o.ecommerce.purchase)
                            if (0 < i && 0 < h) {
                                f.currency_code = l;
                                p = o.ecommerce.purchase.products.length, u = [];
                                for (g = 0; g < p; g++) w = o.ecommerce.purchase.products[g], f.products.push({ id: w.id || w.uid || w.name, price: w.price || 0 }), f.total_price = i;
                                m = "init_checkout"
                            } else m = "t-purchase";
                    else if ("addToCart" == o.event && o.ecommerce.add)
                        if (0 < i && 0 < h) {
                            ...
                            for (g = 0; g < p; g++) w = o.ecommerce.add.products[g], f.products.push({ id: w.id || w.uid || w.name, price: w.price || 0 }), f.total_price = i;
                            m = "add_to_cart"
                        ...
                        if (0 < i && 0 < h) {
                            f.currency_code = l;
                            p = o.ecommerce.detail.products.length, u = [];
                            for (g = 0; g < p; g++) w = o.ecommerce.detail.products[g], f.products.push({ id: w.id || w.uid || w.name, price: w.price || 0 }), f.total_price = i;
                            m = "view_product"
                        ...
                        if (0 < i && 0 < h) {
                            ...
                            var w, g, p = o.ecommerce.remove.products.length,
                                u = [];
                            for (g = 0; g < p; g++) w = o.ecommerce.remove.products[g], f.products.push({ id: w.id || w.uid || w.name, price: w.price || 0 }), f.total_price = i;
                            m = "remove_from_cart"
                        } else m = "t-remove-product", o.ecommerce.remove[0] && o.ecommerce.remove[0].uid && (m += "-" + o.ecommerce.remove[0].uid);
                    else m = o.event;
                    else m = -1 != e.indexOf("tilda/") && -1 != e.indexOf("/payment/") ? "t-purchase-" + e.replace("tilda/", "").replace("/payment/", "") : -1 != e.indexOf("tilda/") && -1 != e.indexOf("/submitted/") ? "t-lead-" + e.replace("tilda/", "").replace("/submitted/", "") : -1 != e.indexOf("tilda/popup") || -1 != e.indexOf("tilda/click") ? "t-" + e.replace("tilda/", "").replace("/", "-") : "t-" + e.replace("/", "-");
            ...
            try { 1 == v("#allrecords").length && "no" == v("#allrecords").data("tilda-cookie") || Tilda.saveUTM() } catch (e) {}
